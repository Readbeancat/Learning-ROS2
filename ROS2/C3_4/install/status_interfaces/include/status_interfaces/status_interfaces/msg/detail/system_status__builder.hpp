...
public:
  ...
  {}
  Init_SystemStatus_host_name timestamp(::status_interfaces::msg::SystemStatus::_timestamp_type arg)
  {
...
{
  return status_interfaces::msg::builder::Init_SystemStatus_timestamp();
}
